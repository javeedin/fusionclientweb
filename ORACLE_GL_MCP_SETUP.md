...
### 1. Add Route to Your Admin Module

In your admin routing file (e.g., `src/App.jsx` or `src/modules/admin/AdminRouter.jsx`):
...
Add MCP SDK to your main `package.json`:
...
Update `package.json` build section to include GL MCP server:

```json
"build": {
  "files": [
    "dist/**/*",
    "electron/**/*",     // includes gl-mcp-server.cjs
    "public/**/*",
    "server/**/*"
  ]
}
