...
export const ALL_MENU_ITEMS: MenuSearchItem[] = [
  ...
  { key: 'gl-business-units',     label: 'Manage Business Units',       module: 'GL',   moduleLabel: 'General Ledger',          path: '/gl/business-units',              description: 'Search and create business units, legal entities and ledgers', keywords: 'bu business unit legal entity ledger company setup' },
  ...
  { key: 'ap-trial-balance',      label: 'Payables Trial Balance',      module: 'AP',   moduleLabel: 'Accounts Payable',        path: '/ap/payables-trial-balance',      description: 'Open accounted liability by account, supplier and invoice as of a date, reconciled to GL', keywords: 'trial balance tb liability open invoices reconcile gl month end outstanding payables' },
  ...
  { key: 'admin-ords-token',      label: 'ORDS OAuth Token',            module: 'ADMIN', moduleLabel: 'Administration',         path: '/admin/ords-token',               description: 'Get a bearer token from the ORDS oauth/token endpoint (client credentials)', keywords: 'ords oauth token bearer client credentials rest security apex' },
  { key: 'admin-ftp-manager',     label: 'FTP Manager',                 module: 'ADMIN', moduleLabel: 'Administration',         path: '/admin/ftp-manager',              description: 'Dual-pane SFTP/FTP file transfer — deploy application files to the hosting server', keywords: 'ftp sftp file transfer upload download deploy server hosting filezilla' },
  { key: 'admin-mcp-registry',    label: 'MCP Registry',                module: 'ADMIN', moduleLabel: 'Administration',         path: '/admin/mcp-registry',             description: 'Data-driven MCP tool definitions for Claude Desktop — add tools without code', keywords: 'mcp model context protocol tools registry claude desktop rest api' },
  { key: 'admin-mcp-logs',        label: 'MCP Activity Log',            module: 'ADMIN', moduleLabel: 'Administration',         path: '/admin/mcp-logs',                 description: 'Audit trail of every Claude MCP tool call and agent run — status, machine, user, output', keywords: 'mcp log audit monitor claude agent run history activity' },
  { key: 'admin-oracle-fusion-ai', label: 'Oracle Fusion AI',           module: 'ADMIN', moduleLabel: 'Administration',         path: '/admin/oracle-fusion-ai',         description: 'Period Close Copilot (close readiness, variance, clearing accounts) + Oracle AI Agent Studio capability map', keywords: 'oracle fusion ai agent studio period close copilot close review variance clearing ledger insights' },
  ...
  // Hidden on request — pages still reachable at /librechat and /claude-cli
  // { key: 'librechat',             label: 'LibreChat AI Chat',           module: 'AI',    moduleLabel: 'AI Chat',                path: '/librechat',                      description: 'Self-hosted LibreChat — Claude with the Oracle GL MCP server tools', keywords: 'librechat ai chat claude anthropic mcp gl tools assistant autopilot' },
  // { key: 'claude-cli',            label: 'Claude Code CLI',             module: 'AI',    moduleLabel: 'AI Chat',                path: '/claude-cli',                     description: 'Embedded Claude Code terminal — subscription-billed, with the ERP MCP servers', keywords: 'claude code cli terminal subscription mcp agent erp' },
  { key: 'claude-chat',           label: 'Claude Chat',                 module: 'AI',    moduleLabel: 'AI Chat',                path: '/claude-chat',                    description: 'Chat UI over Claude Code — subscription-billed, ERP MCP tools, scrollable history', keywords: 'claude chat subscription mcp erp bubbles headless' },
